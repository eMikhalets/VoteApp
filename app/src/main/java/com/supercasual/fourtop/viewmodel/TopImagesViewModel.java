...
public class TopImagesViewModel extends ViewModel {
    ...
    public void sendTopPhotosRequest(String token, ImageAdapter adapter) {
        ...
        Call<ImagesResponse> responseCall = ApiFactory.getApiFactory().getApiService().topPhotos(tokenBody, countBody, offsetBody);
